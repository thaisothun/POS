...
async function sale_transaction_report_excel(start_date, end_date, path){
    ...
    try {
        ...
        if (!response.ok) throw new Error('Network response was not ok');
            ...
            a.href = url;
            a.download = `purchase_report_by_date_generated_${now.toLocaleString()}.xlsx`;
...
document.getElementById('generate').addEventListener('click', ()=>{
    sale_transaction_report(start_date, end_date, '/report_management/generate-report/purchase-by-date/generate/')})

document.getElementById('excel').addEventListener('click', ()=>{
    sale_transaction_report_excel(start_date, end_date, '/report_management/generate-report/purchase-by-date/excel/')})
