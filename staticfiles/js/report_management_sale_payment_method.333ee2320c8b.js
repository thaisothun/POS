...
start_date.addEventListener('change', ()=>{
    ...
    if (new Date(start_date.value) > current_date){
        Swal.fire({
            title: "Sale Report By Payment Method",
...
async function sale_transaction_report(start_date, end_date, path){
    ...
    if(!payment_method){
         Swal.fire({
            title: "Sale Report By Payment Mehtod",
...
async function sale_transaction_report_excel(start_date, end_date, path){
    ...
    try {
        ...
        if (!response.ok) throw new Error('Network response was not ok');
            ...
            a.href = url;
            a.download = `sales_report_by_payment_method_generated_${now.toLocaleString()}.xlsx`;
...
document.getElementById('generate').addEventListener('click', ()=>{
    sale_transaction_report(start_date, end_date, '/report_management/generate-report/sale-by-payment-method/generate/')})

document.getElementById('excel').addEventListener('click', ()=>{
    sale_transaction_report_excel(start_date, end_date, '/report_management/generate-report/sale-by-payment-method/excel/')})
