...
async function sale_transaction_report(start_date, end_date, path){
    ...
    data_send = {start_date : start_date.value, end_date : end_date.value, option:option}
    if (option != 'all'){   
...
async function sale_transaction_report_excel(start_date, end_date, path){
    ...
    try {
        ...
        if (!response.ok) throw new Error('Network response was not ok');
            ...
            a.href = url;
            a.download = `inventory_report_by_item_${now.toLocaleString()}.xlsx`;
...
document.getElementById('generate').addEventListener('click', ()=>{
    sale_transaction_report(start_date, end_date, '/report_management/generate-report/inventory-items/generate/')})

document.getElementById('excel').addEventListener('click', ()=>{
    sale_transaction_report_excel(start_date, end_date, '/report_management/generate-report/inventory-items/excel/')})
