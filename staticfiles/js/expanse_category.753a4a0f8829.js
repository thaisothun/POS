...
async function category(data) {
    ...
    if (search.value == ''){
        ...
        try {
            const response = await fetch('/expanse-management/category/sort/', {
            method: 'POST',
            headers: {
        ...
        try {
            const response = await fetch('/expanse-management/category/search/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
...
async function get_category(div_name, product_id) {
    ...
    try {
        const response = await fetch('/expanse-management/category/get/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
form.addEventListener('submit', async function(e){
    ...
    try {
        const response = await fetch(`/expanse-management/category/modify/${id}/`, {
        method: 'POST',
        headers: {
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
            },
        ...
        if (!response.ok) throw new Error('Network response was not ok');
            ...
            if (data.message){
                ...
                show_div('wrapper_modify_category')
