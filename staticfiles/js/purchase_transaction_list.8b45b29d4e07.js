...
async function sale_transaction_filter_date(){
    ...
    try {
        const response = await fetch(`/purchase-transaction/purchase-transaction-list/filtter-date/`, {
        method: 'POST',
        headers: {
...
async function sale_transaction(data) {
    ...
    if (search.value == ''){
        ...
        try {
            const response = await fetch('/purchase-transaction/purchase-transaction-list/sort/', {
            method: 'POST',
            headers: {
        ...
        try {
            const response = await fetch('/purchase-transaction/purchase-transaction-list/search/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
...
async function send_get_data(id) {
    ...
    const data_send = {id : id}
        try {
        const response = await fetch('/purchase-transaction/print-receipt/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
...
form_delete_invoice.addEventListener('submit', async function(e){
    ...
    try {
        const response = await fetch(`/purchase-transaction/purchase-transaction-list/delete/${id}/`, {
        method: 'POST',
        headers: {
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
            },
...
async function payment_filter(payment_method){
    ...
    try {
    const response = await fetch(`/purchase-transaction/purchase-transaction-list/filter/payment-method/`, {
    method: 'POST',
    headers: {
        'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
        },
...
async function get_purchase_transaction(div, id,payment_method_condition){
    show_div(div)
    try {
        const response = await fetch(`/purchase-transaction/purchase-transaction-list/invoice/get/${id}/`, {
        method: 'POST',
        headers: {
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
            },
...
async function save_purchase_transaction(){
    let cart = JSON.parse(localStorage.getItem('cart'))
    ...
    try {
        const response = await fetch('/purchase-transaction/purchase-transaction-list/invoice/save/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
...
async function paid_purchase_transaction() {
    ...
    const data_send = {cart : cart, promotion_code :promotion_code, discount:discount, payment_method: payment_method, invoice_number:invoice_number, invoice_number_id : invoice_number_id}
    try {
        const response = await fetch('/purchase-transaction/purchase-transaction-list/invoice/paid/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCookie('csrftoken') // Embedded directly in a Django template
